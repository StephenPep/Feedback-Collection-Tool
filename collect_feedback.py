...
#     concerns_list = [concern for r in responses for concern in r["concerns"]]
#     common_concerns = Counter(concerns_list).most_common(3)
#
#     report = {
#         "Total Responses": total_responses,
#         "Average Rating": round(average_rating, 2),
#         "Top Concerns": common_concerns
#     }
#
#     with open("report.json", "w") as file:
#         json.dump(report, file, indent=4)
#
#     print("Analysis completed. Report saved.")
#     print(report)
#
#
# if __name__ == "__main__":
#     while True:
#         choice = input("Choose an option: (1) Collect Feedback (2) Analyze Feedback (3) Exit: ")
#         if choice == '1':
#             collect_feedback()
#         elif choice == '2':
#             analyze_feedback()
